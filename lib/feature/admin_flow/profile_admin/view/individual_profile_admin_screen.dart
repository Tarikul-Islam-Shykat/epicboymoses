...
import 'package:epicboymoses/feature/user_flow/cleaner_details/cleaneer_details_controller.dart';
...
class IndividualProfileListAdminScreen extends StatelessWidget {
  const IndividualProfileListAdminScreen({super.key});
                ...
                child: Column(
                  children: [
                    _profileWidget(
                      ...
                      "Service List",
                      () {
                        Get.toNamed(AppRoute.serviceListAdminScreen);
                      },
                      true,
                    ),
                    _profileWidget(
