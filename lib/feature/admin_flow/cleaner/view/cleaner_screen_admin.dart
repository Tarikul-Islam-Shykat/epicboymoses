...
import 'package:epicboymoses/feature/admin_flow/cleaner/controller/cleaner_admin_controller.dart';
import 'package:flutter/material.dart';
import 'package:flutter_screenutil/flutter_screenutil.dart';
import 'package:get/get.dart';

class CleanScreenAdmin extends StatelessWidget {
  const CleanScreenAdmin({super.key});

  @override
  Widget build(BuildContext context) {
    CleanAdminController controller = Get.put(CleanAdminController());
    return Scaffold(
