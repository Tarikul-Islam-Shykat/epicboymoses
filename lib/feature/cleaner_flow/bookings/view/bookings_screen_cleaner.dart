...
class BookingsScreenCleaner extends StatelessWidget {
  const BookingsScreenCleaner({super.key});

  @override
  Widget build(BuildContext context) {
    BookingsControllerCleaner controller = Get.put(BookingsControllerCleaner());
    return Scaffold(
